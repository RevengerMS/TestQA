...
* Заполняем табличную часть Товары
	...
	Тогда открылось окно "Продажа товара (создание) *"
	И в таблице 'Товары' в поле с именем 'ТоварыЦена' я ввожу текст "2 200,00"
...
* Проверка печатной формы Печать расходной накладной
	...
	Тогда табличный документ 'SpreadsheetDocument' равен:
		...
		| 'Склад'         | 'Малый'                                         | ''           | ''      |
		| 'Сумма'         | '4 400 рублей (Четыре тысячи четыреста рублей)' | ''           | ''      |
		| 'Вес'           | ''                                              | ''           | ''      |
		| ''              | ''                                              | ''           | ''      |
		| 'Товар'         | 'Цена'                                          | 'Количество' | 'Сумма' |
		| 'Ботинки'       | '2 200'                                         | '2'          | '4 400' |
* Закрываем все окна
	И я закрываю все окна клиентского приложения